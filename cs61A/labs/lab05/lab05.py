...
def add_trees(t1, t2):
    ...
    r1, r2 = branches(t1), branches(t2)
    length_t1, length_t2 = len(r1), len(r2)
    if length_t1 < length_t2:
        r1 += [None for _ in range(length_t1, length_t2)]
    elif length_t1 > length_t2:
        r2 += [None for _ in range(length_t2, length_t1)]
    return tree(l1 + l2, [add_trees(x, y) for x, y in zip(r1, r2)])
