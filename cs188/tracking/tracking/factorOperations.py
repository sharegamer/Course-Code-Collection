...
def joinFactors(factors: List[Factor]):
    ...
    # Remove any unconditioned variables from the conditioned set
    ...
    # Set the probability for each assignment in the new factor
...
def eliminateWithCallTracking(callTrackingList=None):
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        variableDomainsDict=factor.variableDomainsDict()
        all_assignment=new_factor.getAllPossibleAssignmentDicts()
        for assignment in all_assignment:
            ...
            new_factor.setProbability(assignment,pro)
        return new_factor
